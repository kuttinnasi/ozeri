...
<head>
    ...
    <!--====== Title ======-->
    <title>Podcasts Channels &#8211; Fr Peter Mary Rookey &#8211; Servite Friar</title>

    <meta name="description" content="Podcast channels for Praying the Rosary with Fr. Peter Rookey OSM and Meetings with Fr. Peter Rookey OSM." />
    ...
    <section class="about-area">
        <div class="container">
            <div class="section-content">
                <h2 class="blog-title" style="color: #2c5aa0; border-bottom: 2px solid #ddd; padding-bottom: 15px; margin-bottom: 40px;">Podcasts Channels</h2>
                
                <!-- Section 1 -->
                <div class="podcast-section">
                    <h3>PRAYING THE ROSARY WITH FR PETER ROOKEY OSM</h3>
                    <p>Pray the Mysteries of the Holy Rosary, the Seven Sorrows Rosary, the Way of the Cross and the Miracle Prayer with Fr Peter Rookey.</p>
                    <p>Fr. Peter Mary Rookey OSM was a Roman Catholic friar and priest, ordained into the Servite Order on May 17, 1941 at Our Lady of Sorrows Basilica in Chicago. He was referred to as 'The Man of Miracles' or 'The Healing Priest' He was known and loved for his commitment to the Divine Office, the Holy Rosary, the prayerful celebration of the Eucharist and the healing ministry. Thousands have testified to healing in spirit, soul and body through his ministry and intercessory prayer.</p>
                ...
                <!-- Section 2 -->
                <div class="podcast-section">
                    <h3>NEW PODCAST CHANNEL FOR FR PETER ROOKEY!</h3>
                    <div style="margin-bottom: 20px;">
                        <strong>PODCAST CHANNEL:</strong> Meetings with Fr Peter Rookey OSM
                    </div>
